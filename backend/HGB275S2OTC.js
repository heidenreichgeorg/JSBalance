        ...
        <SCRIPT type="text/javascript" src="/money.js"></SCRIPT>
            ...
            function putResponse(strTarget,strText) {       
                ...
                if(page) {           
                    ...
                    var htmlPage = createPage(['L120','L175','R165','R110'],"<DIV class='attrLine'>"+headerInfo+"</DIV>",'PageContent');
                    var cursor=htmlPage;
                    ...
                    for (let name in jAccounts)   {
                        ...
                        if(gross && iName && full_xbrl) {
                            ...
                            console.log("READ xbrl="+full_xbrl+" "+chgb5+" "+chgb7+" "+chgb8+" "+chgbA+" "+chgbB+" "+chgbD+" "+chgbE);
                        }
