        ...
        <SCRIPT type="text/javascript" src="/money.js"></SCRIPT>
            ...
            function putResponse(strTarget,strText) {       
                ...
                var htmlPage = createPage( ['L220','L120','L120','L150','R110','R110'],"<DIV class='attrLine'>"+headerInfo+"</DIV>",'PageContent');
                cursor=htmlPage;
...
//                let headerInfo = '<DIV class="attrLine"><DIV class="C280">'+gPage["AcctHistory"]+'&nbsp;'+name+'&nbsp;'+gPage["header"]+'</DIV></DIV>';
                ...
                var htmlPage = createPage( ['L40', 'C100','L110','L110','L110','L110','R110','R110'],"<DIV class='attrLine'>"+headerInfo+"</DIV>",'PageContent');
                var cursor=htmlPage;
